    ...
    questions = {
        ...
        "mirror_dream":{
            ...
            "answer_lines":[
                ...
                {"choices":[
                    {"text":"""You're wrong. This is two sequesntial dreams, a dream within a dream 
                    means that I fell asleep in a dream and then began another, not this.""", 
                    "effects":{"decon":+add_most}},
                    
                    {"text":"I am special! If a strange mirror took attention to me, I must be.", 
                    "effects":{"royal":+add_most}},

                    {"text":"""Now that I've heart that, I've realized that being in 'a dream 
                    within a dream' isn't anything to concern myself more than any other dream.""", 
                    "effects":{"aloof":+add_most}},

                    {"text":"""But I know what my dream was! It was a prince and princess getting
        ...
        "mirror_other_dream":{
            ...
            "answer_lines":[
                ...
                {"who":"mirror", 
                "text":"""It could of been of flight, of stress, of a grand never-ending tale, but
                none of these would change that I am talking to you, in the here, in the now."""},
                ...
                {"choices":[
                    ...
                    {"text":"""You're wrong, there was a prince and a princess, that had to mean
                    something...because if they didn't, doesn't that mean I also mean nothing...""", 
                    "effects":{"royal":+add_some, "decon":+add_some}},
                    
                    {"text":"""You're wrong, I made an opinion about that dream. It may not have
                    been a good opinion or a correct opinion, but it was an opinion nonetheless
                    that dream must have meant something, to me if no one else.""", 
                    "effects":{"decon":+add_most}}
                ]}
            ],
            "hub":"mirror",
        ...
        "mirror_leave":{
            ...
            "answer_lines":[
                ...
                {"choices":[
                    ...
                    {"text":"""I knew that much, but I don't know if this could be like a 
                    nightmare, a dream from which I can't simply 'wake up'.""", 
                    "effects":{"decon":+add_most}},
                    
                    {"text":"""That sounds almost too simple, there must be a catch for such a 
                    unique situation.""", 
                    "effects":{"royal":+add_some, "decon":+add_some}},
        ...
        "mirror_what":{
            ...
            "answer_lines":[
                ...
                {"who":"mirror", 
                "text":"""And all I know is that for every question asked I lose a little more 
                of 'myself'."""},
                ...
                {"choices":[
                    ...
                    {"text":"""I think what you 'represent' doesn't matter. You're just here to 
                    answer my questions.""", 
        ...
        "mirror_made_of":{
            ...
            "answer_lines":[
                ...
                {"choices":[
                    ...
                    {"text":"""You're keeper was foolish, an ordinary mirror, no matter how magic 
                    was added can't be 'free', whatever that means.""", 
                    "effects":{"royal":+add_some, "aloof":+add_some}},
                    
                    {"text":"""I need not be concerned with what a former person wanted...but it 
                    doesn't feel--no, I am not concerned with...with that.""", 
                    "effects":{"aloof":+add_most}}
                ]}
            ],
            "hub":"mirror",
        ...
        "mirror_am_me":{
            ...
            "answer_lines":[
                ...
                {"choices":[
                    ...
                    {"text":"""I didn't want an easy way out, I wanted to know if I'm-I'm 
                    something or somesone--someone different! Not just a reflection in a mirror!""", 
                    "effects":{"royal":+add_some, "decon":+add_some}},
                    {"text":"", "effects":{}}
                ]}
            ],
        ...
        "mirror_who":{
            ...
            "answer_lines":[
                {"who":"mirror", 
                "text":"""You are a Princess, of course. Someone of sufficient import, but not so
                politically active that you'll be missed, after all your parents have more than
                enough spawn that five could go missing without anyone in court noticing."""},

                {"who":"mirror", 
                "text":"""You also have many titles gifted for a variety of reasons. You are 
                Heir to the Billyburrows, Duchess of Viantara, and the Dreamer of Zalon, among
                many others."""},
                ...
                {"choices":[
                    ...
                    {"text":"""It doesn't amtter what titles I have, I'm already myself and that's
                    more than unique enough.""", 
                    "effects":{"royal":+add_little, "decon":+add_little, "aloof":+add_little}},
        ...
        "mirror_titles":{
            ...
            "answer_lines":[
                ...
                {"who":"mirror", 
                "text":"""At least, they won't earn you any respect nor do they contain even an
                iota of power, thus they mean nothing"""},
        ...
        "mirror_but_who":{
            ...
            "answer_lines":[
                ...
                {"choices":[
                    ...
                    {"text":"""I implies I'm famous, if over a thousand people have an opinion on 
                    me, be they good or bad, I do not know. I suppose I am honoured.""", 
                    "effects":{"royal":+add_some, "decon":+add_some}},
        ...
        "mirror_reflection":{
            ...
            "answer_lines":[
                ...
                {"choices":[
                    ...
                    {"text":"""I guess you're not a real mirror, just one conjured by my own mind 
                    as a representation of 'me'--more specificly the 'me' with answers--and that's
                    why I cannot see 'myself' as I do not have any answers.""", 
                    "effects":{"decon":+add_most}},
        ...
        "mirror_story":{
            ...
            "answer_lines":[
                ...
                {"choices":[
                    ...
                    {"text":"""I don't know, it felt right, like something that will happen, but
                    the future doesn't matter, not yet, not compared to the present.""", 
                    "effects":{"royal":+add_little, "decon":+add_little, "aloof":+add_little}},
                    
                    {"text":"""If it was a dream then it must symbolize something. Like maybe I
                    desire marriage above all else--no that doesn't sound right; maybe I want
                    stability--I think that's closer; or maybe--no, i don't think there's any
                    use speculating.""", 
                    "effects":{"decon":+add_most}},
        ...
        "mirror_will_story":{
            ...
            "answer_lines":[
                {"who":"mirror", 
                "text":"I don't even knoe waht story you're talking about."},

                {"who":"mirror", 
                "text":"""But in a sense, all stories will happen sooner or later, it's just a 
                question of whether you're alive at that point, after every possible event of 
                this world has been played out."""},
                ...
                {"choices":[
                    ...
                    {"text":"""That can't be right, some things are just impossible. Like touching
                    a falling star""", 
                    "effects":{"decon":+add_some, "aloof":+add_some}}
                ]}
            ],
        ...
        "mirror_but_why":{
            ...
            "answer_lines":[
                ...
                {"choices":[
                    ...
                    {"text":"""A pointless answer. Sure, i'm needed, that's good, but doesn't 
                    explain why I'm here.""", 
                    "effects":{"royal":+add_some, "decon":+add_some}},
                    
                    {"text":"""That can't be right, I couldn't have been useful to the running of a 
                    kingdom, at least I don't think so, at most I would have been a figurehead.""", 
                    "effects":{"decon":+add_most}},
